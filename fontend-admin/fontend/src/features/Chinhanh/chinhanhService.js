...
const createChinhanh = async (chinhanh) => {
  const response = await axios.post(`${base_url}ChiNhanhs/`, chinhanh, config);
...
const getChinhanh = async (maCN) => {
  const response = await axios.get(`${base_url}ChiNhanhs/${maCN}`, config);

  return response.data;
};

const getChinhanhad = async (maCH) => {
  const response = await axios.get(`${base_url}CNAD/${maCH}`, config);

  return response.data;
};

const deleteChinhanh = async (maCN) => {
  const response = await axios.delete(`${base_url}ChiNhanhs/${maCN}`, config);
